...
public class HeartView: UIView {
    ...
    private func drawHeartInRect(rect: CGRect) {
        ...
        heartPath.addArc(withCenter: CGPoint(x: topRightCurveStart.x + curveRadius, y: topRightCurveStart.y), radius: curveRadius, startAngle: CGFloat(PI), endAngle: 0, clockwise: true)
